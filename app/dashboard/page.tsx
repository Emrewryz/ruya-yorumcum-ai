            ...
            {status === 'COMPLETED' && analysisResult && (
               <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="w-full bg-gradient-to-b from-black/40 to-[#020617] border-t border-white/10 pb-32">
                  <div className="w-full max-w-4xl mx-auto px-6 py-16">
                      ...
                      {/* 3. YENİ GÖRSEL STÜDYOSU KARTI (FULL WIDTH) */}
                      <div className="relative w-full rounded-3xl overflow-hidden mb-12 border border-white/10 shadow-2xl bg-[#0a0a0a] group">
                         ...
                         {generatedImage ? (
                            ...
                            <div className="relative w-full p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
                               ...
                               {/* Sağ Taraf: Örnek Görsel (Placeholder) */}
                      ...
                      {/* 4. WIDGETLAR (Görselin Altına İndi) */}
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                         <div onClick={() => router.push('/dashboard/duygu-durumu')} className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:border-[#fbbf24]/50 cursor-pointer transition-all group relative overflow-hidden">
                         ...
                         <div onClick={() => router.push('/dashboard/numeroloji')} className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:border-[#fbbf24]/50 cursor-pointer transition-all group text-center">
                         ...
                         <div onClick={() => router.push('/dashboard/tarot')} className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:border-purple-500/50 cursor-pointer transition-all group relative overflow-hidden flex flex-col justify-between">

      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="mb-8 md:mb-12">
           <div className="relative w-full max-w-md mx-auto group">
              ...
              <div className="relative flex items-center bg-[#0f172a] border border-white/10 rounded-full px-5 py-3 transition-colors group-focus-within:border-[#fbbf24]/50">

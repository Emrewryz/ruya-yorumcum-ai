...
import { 
  Sparkles, MapPin, ArrowRight, Crown, Star, 
             ...
             <div className="max-w-6xl mx-auto w-full pt-6 md:pt-0">
                ...
                >
                    ...
                    <div className="flex gap-3">
                        <div className="px-4 py-2 md:px-5 md:py-2.5 bg-white/5 backdrop-blur-sm rounded-full text-[10px] md:text-xs font-bold uppercase border border-white/10 flex items-center gap-2 hover:bg-white/10 transition-colors">
                            <Crown className={`w-3 h-3 md:w-4 md:h-4 ${profile.subscription_tier === 'elite' ? 'text-amber-400' : 'text-yellow-400'}`} /> 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center text-indigo-400 font-bold text-xs md:text-sm tracking-widest uppercase group-hover:text-indigo-300 transition-colors mt-4 md:mt-0">
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center text-purple-400 font-bold text-xs md:text-sm tracking-widest uppercase group-hover:text-purple-300 transition-colors mt-4 md:mt-0">

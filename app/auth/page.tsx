...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex items-center justify-center relative overflow-hidden font-sans p-4">
      ...
      {/* Ortada simsiyah, etrafında altın hare */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-black rounded-full shadow-[0_0_80px_20px_rgba(251,191,36,0.15)] z-0">
      ...
      <motion.div 
        ...
        className="relative z-10 w-full max-w-[400px] bg-white/5 backdrop-blur-md border border-[#fbbf24]/30 rounded-3xl shadow-2xl p-8"
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#fbbf24]/80 text-xs tracking-[0.3em] uppercase">Bilinçaltı Kapısı</p>
        </div>

        {/* Google Butonu (Siyah Cam & Neon Beyaz) */}
        <button 
          onClick={handleGoogleLogin}
          className="w-full bg-black/50 hover:bg-black/70 border border-white/10 hover:border-white text-white py-3 rounded-xl flex items-center justify-center gap-3 transition-all duration-300 shadow-[0_0_0_transparent] hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] group mb-8"
        >
              ...
              >
                <div className="relative group">
                  <input 
                    ...
                    required={!isLogin}
                    className="w-full bg-transparent border-b border-white/20 py-3 pr-10 text-white placeholder-gray-500 focus:outline-none transition-all"
                  />
                  {/* İkon Sağda */}
        ...
        <div className="mt-8 text-center">
          <button 
            ...
            className="text-gray-500 text-xs hover:text-[#fbbf24] transition-colors tracking-wider"
          >

                ...
                >
                    ...
                    <div className="relative group mb-6">
                        ...
                        <input 
                            ...
                            className="relative w-full bg-[var(--bg-main)] dark:bg-[#0B0F19] text-[var(--text-main)] p-5 rounded-2xl border border-[var(--border-color)] dark:border-white/5 outline-none focus:border-rose-500/50 transition-colors text-center text-sm md:text-base placeholder:text-[var(--text-muted)] shadow-inner dark:shadow-none"

...
export default async function BlogListingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-[#fbbf24]/30 pb-20 relative overflow-x-hidden">
      
      {/* --- 1. ATMOSFER & ZEMİN --- */}
      <div className="bg-noise fixed inset-0 opacity-[0.04] pointer-events-none z-50"></div>
      <div className="fixed top-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#fbbf24]/10 rounded-full blur-[120px] pointer-events-none z-0"></div>
      <div className="fixed bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#4c1d95]/10 rounded-full blur-[120px] pointer-events-none z-0"></div>

      {/* --- 2. HERO BÖLÜMÜ --- */}
      <section className="relative z-10 pt-40 pb-16 px-4 text-center border-b border-white/5 bg-gradient-to-b from-[#020617] to-[#0f172a]">
        <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-[#fbbf24] text-xs font-bold tracking-widest uppercase mb-6 hover:bg-white/10 transition-colors cursor-default">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-16 relative z-10">
        ...
        {featuredPost && (
            <div className="mb-16">
                <Link href={`/blog/${featuredPost.slug}`} className="group relative block rounded-3xl overflow-hidden aspect-[4/3] md:aspect-[21/9] border border-white/10">
                    <img 
                    ...
                    <div className="absolute bottom-0 left-0 p-6 md:p-12 w-full md:w-2/3">
                        <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-[#fbbf24] mb-4">
                            <span className="bg-[#fbbf24]/10 px-3 py-1 rounded-full border border-[#fbbf24]/20">Öne Çıkan</span>
                        ...
                        <h2 className="font-serif text-3xl md:text-5xl font-bold text-white mb-4 leading-tight group-hover:text-[#fbbf24] transition-colors">
                            {featuredPost.title}
                        </h2>
                        <p className="text-gray-300 text-sm md:text-lg line-clamp-2 md:line-clamp-3 mb-6">
                            {featuredPost.excerpt}
                        </p>
                        <div className="inline-flex items-center gap-2 text-white font-bold border-b border-[#fbbf24] pb-1 group-hover:gap-4 transition-all">
                            Makaleyi Oku <ChevronRight className="w-4 h-4" />
                        </div>
                    </div>
                </Link>
            </div>
            ...
            <Link key={post.slug} href={`/blog/${post.slug}`} className="group h-full">
              <article className="h-full bg-[#0f172a] border border-white/5 rounded-2xl overflow-hidden hover:border-[#fbbf24]/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl flex flex-col">
                ...
                <div className="aspect-video bg-white/5 relative overflow-hidden">
                  ...
                  {/* Kategori Etiketi (Opsiyonel - Şimdilik Blog) */}
                  <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 bg-black/60 backdrop-blur-md rounded-lg text-[10px] font-bold uppercase text-[#fbbf24] border border-white/10">
                        Rehber
                      </span>
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <h2 className="font-serif text-xl font-bold text-white mb-3 group-hover:text-[#fbbf24] transition-colors line-clamp-2 leading-tight">
                    {post.title}
                  </h2>
                  ...
                  <div className="flex items-center justify-between mt-auto border-t border-white/5 pt-4">
                    <span className="text-xs font-bold text-[#fbbf24] uppercase tracking-wider flex items-center gap-1 group-hover:gap-2 transition-all">
        ...
        <div className="mt-20 relative rounded-3xl overflow-hidden bg-[#0f172a] border border-white/10 p-8 md:p-12 text-center">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <Link href="/dashboard" className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-[#fbbf24] text-black font-bold hover:scale-105 transition-transform shadow-lg">

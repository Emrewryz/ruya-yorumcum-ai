...
export default function ViralTestClient({ slug }: { slug: string }) {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        if (current < test.content.questions.length - 1) {
          ...
          setResult(found);
          localStorage.setItem(STORAGE_KEY(slug), JSON.stringify({ category: found.category }));
          setPhase("loading");
        }
      }, 280);
    }, 450);
                ...
                {q.options.map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={!!selected}
                      className={`
                        w-full text-left rounded-xl border px-4 py-3.5 text-sm
                    ...
                    >
                      <span className={`
                        ...
                        text-[10px] font-bold mr-3 shrink-0 align-middle
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={() => {
                ...
                setResult(null); setSlideOut(false); setPhase("quiz");
              }}
          ...
          <article className="mt-12">
            <div className="border-t border-zinc-100 pt-10 space-y-8">
              ...
              {!seo && (
                <>
                  <section>
                    <h2 className="text-base font-semibold text-zinc-800 mb-2">Bu Test Nasıl Hazırlandı?</h2>
                    <p className="text-sm leading-loose text-zinc-500">
                      ...
                      Rüya Yorumcum uzman kadrosu tarafından hazırlandı.
                    </p>
                  </section>
                  <section>
                    <h2 className="text-base font-semibold text-zinc-800 mb-2">Bilinçaltı ve Rüyalar</h2>
                    <p className="text-sm leading-loose text-zinc-500">
                      Carl Jung'a göre rüyalar, bilinçaltının dilidir. Bu test, o örüntüleri yüzeye
                      çıkarmak için bir başlangıç noktası sunar.
                    </p>
                  </section>
                </>
              )}
              <section className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5 text-center">
